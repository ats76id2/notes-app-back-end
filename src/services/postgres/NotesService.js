...
class NotesService {
  ...
  async addNote({
    ...
    // Dengan begitu kita perlu menambahkan dependency terhadap CollaborationsService di dalam NotesService
    // untuk memverifikasi hak akses pengguna (userId) terhadap catatan (id), 
    // baik sebagai owner maupun collaboration. Untuk lolos tahap verifikasi, 
    ...
    // Melainkan ia memanfaatkan fungsi yang sudah dibuat sebelumnya, yakni verifyNoteOwner dan verifyCollaborator.
